...
$(function() {
	...
	$(window).resize(function() {
		delay(function() {
				...
				function imageWidth() {
          return Math.max(1, ($('body').width()/1920)) * $('#slide-3 img').width();
        }

				var gallery_width = imageWidth() * $('#slide-3 img').length;
				gallery_width /= 2;
				...
				var left_pos = imageWidth() - $('body').width();
				left_pos /= -2;
